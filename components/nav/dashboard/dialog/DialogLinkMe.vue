<template>
    <Dialog>
      <DialogTrigger>
        <Button variant="ghost" class="w-full font-semibold flex justify-start items-center">
          <Icon name="fluent:person-20-regular" class="text-xl mr-2" />
          For me
        </Button>
      </DialogTrigger>
      <DialogContent>
