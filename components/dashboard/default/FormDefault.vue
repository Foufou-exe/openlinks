<template>
  <div class="space-y-10">
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4" v-show="currentViewMode === 'grid'">
      <CardStats v-for="stat in stats" :key="stat.title" :title="stat.title" :icon="stat.icon" :total="stat.total"
        :description="stat.description" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-3" v-show="currentViewMode === 'line'">
      <CardStatsSimple v-for="stat in stats" :key="stat.title" :title="stat.title" :icon="stat.icon" :total="stat.total"
        :description="stat.description" />
    </div>
    ...
    <div
      ...
      <div class="flex justify-items-center justify-start items-center space-x-1">
        ...
        <div>
          ...
          <p class="text-xs sm:text-sm text-gray-500">
            Add links to your recent list.
          </p>
        </div>
      </div>
      <div class="flex justify-center items-center">
        <Button variant="ghost" as-child>
          <a href="/dashboard/manage/recent">
            Views all
    ...
    <div v-show="currentViewMode === 'grid'"
      ...
      <CardLinks v-for="link in filteRecents" :key="link.id" :titleLink="link.title" :category="link.category"
    ...
    <div class="grid grid-cols-1 gap-3" v-show="currentViewMode === 'line'">
      <CardLinksSimple v-for="link in filteRecents" :key="link.id" :titleLink="link.title" :category="link.category"
        :date="link.date" :time="link.time" :imagesLink="link.images" :hrefLink="link.href"
        :descriptionLink="link.description" :imageLink="link.imageLink" />
    </div>
    ...
    <div
      ...
      <div class="flex justify-center items-center">
        <Button variant="ghost" as-child>
          <a href="/dashboard/manage/favours">
            Views all
            <Icon name="fluent:arrow-right-24-regular" class="text-lg ml-1" />
          </a>
        </Button>
    ...
    <div v-show="currentViewMode === 'grid'"
      class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-4 4xl:grid-cols-6 gap-5 justify-items-center">
      <CardLinks v-for="link in filterFavorite" :key="link.id" :titleLink="link.title" :category="link.category"
        :date="link.date" :time="link.time" :imagesLink="link.images" :hrefLink="link.href"
        :descriptionLink="link.description" :imageLink="link.imageLink" />
    </div>
    ...
    <div class="grid grid-cols-1 gap-3" v-show="currentViewMode === 'line'">
      <CardLinksSimple v-for="link in filterFavorite" :key="link.id" :titleLink="link.title" :category="link.category"
        :date="link.date" :time="link.time" :imagesLink="link.images" :hrefLink="link.href"
        :descriptionLink="link.description" :imageLink="link.imageLink" />
    </div>
    ...
    <div
      ...
      <div class="flex justify-center items-center">
        <Button variant="ghost" as-child>
          <a href="/dashboard/manage/history">
            Views all
            <Icon name="fluent:arrow-right-24-regular" class="text-lg ml-1" />
          </a>
        </Button>
    ...
    <div v-show="currentViewMode === 'grid'"
      class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-4 4xl:grid-cols-6 gap-5 justify-items-center">
      <CardLinks v-for="link in filterHistory" :key="link.id" :titleLink="link.title" :category="link.category"
        :date="link.date" :time="link.time" :imagesLink="link.images" :hrefLink="link.href"
        :descriptionLink="link.description" :imageLink="link.imageLink" />
    </div>
    ...
    <div class="grid grid-cols-1 gap-3" v-show="currentViewMode === 'line'">
      <CardLinksSimple v-for="link in filterHistory" :key="link.id" :titleLink="link.title" :category="link.category"
        :date="link.date" :time="link.time" :imagesLink="link.images" :hrefLink="link.href"
        :descriptionLink="link.description" :imageLink="link.imageLink" />
    </div>
...
const filterFavorite = computed(() => {
  return links.filter((link) => link.favorite == true).slice(0, 4);
});

const filteRecents = computed(() => {
  return links.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).slice(0, 4);
});

const filterHistory = computed(() => {
  return [...links].sort((a, b) => new Date(b.lastVisite).getTime() - new Date(a.lastVisite).getTime()).slice(0, 4);
});
